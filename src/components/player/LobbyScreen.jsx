    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-gradient-to-br from-[#0f0a1e] via-[#1a0a2e] to-[#0a1628]">
      ...
      >
        ...
        <div className="glass rounded-2xl p-6 mt-6 space-y-4">
          <div>
            <p className="text-white/50 text-xs uppercase tracking-wider font-semibold">{t('lobby.joinedAs')}</p>
          ...
          <div>
            <p className="text-white/50 text-xs uppercase tracking-wider font-semibold">{t('lobby.players')}</p>
            <motion.p
              key={playerCount}
          ...
          <div className="flex items-center justify-center gap-2 text-brand-300">
            ...
            <span className="text-sm font-medium">{t('lobby.waiting')}</span>
          </div>
        </div>
      </motion.div>
    </div>
